    ...
    <div className="space-y-6">
      ...
      <SectionCard title="Technology Stack" icon={Server}>
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            <h4 className="font-semibold text-slate-700 mb-2">Backend (Base44 Platform)</h4>
            <ul className="text-sm text-slate-600 space-y-1">
              <li>• Base44 SDK (@base44/sdk)</li>
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            ...
            <ul className="text-sm text-slate-600 space-y-1">
              <li>• WhatsApp (via Base44 Agents)</li>
      ...
      <SectionCard title="Authentication & Security" icon={Shield}>
        <div className="space-y-4 text-sm">
          <div className="bg-slate-50 p-4 rounded">
            ...
            <ul className="text-slate-600 space-y-1">
              <li>• Built-in Base44 authentication (email/password)</li>
              <li>• No custom login page needed</li>
              <li>• <code className="bg-slate-200 px-1 rounded">base44.auth.me()</code> - Get current user</li>
              <li>• <code className="bg-slate-200 px-1 rounded">base44.auth.logout()</code> - Logout</li>
              <li>• <code className="bg-slate-200 px-1 rounded">base44.auth.redirectToLogin()</code> - Redirect to login</li>
            </ul>
          </div>
          <div className="bg-slate-50 p-4 rounded">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded border border-blue-200">
            ...
            <p className="text-blue-700 text-sm">
              BASE44_APP_ID is automatically set by the platform. Do not manually configure.
            </p>
          </div>
        </div>
      </SectionCard>
