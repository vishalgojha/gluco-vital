...
import { ArrowLeft, RefreshCcw, XCircle, Clock, CreditCard, AlertCircle } from "lucide-react";
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <p className="text-slate-600">
                At GlucoVital.fit, we want you to be completely satisfied with our services. This policy outlines the terms for subscription cancellations and refunds.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#5b9a8b]/5 rounded-xl p-4 border border-[#5b9a8b]/20">
                  <h3 className="font-semibold text-[#5b9a8b] mb-2">7-Day Money-Back Guarantee</h3>
                  <p className="text-slate-600 text-sm">
                    If you are not satisfied with your Premium or Family subscription, you may request a <strong>full refund within 7 days</strong> of your initial purchase. No questions asked.
                  </p>
                </div>

                {/* Refund eligibility */}
                <div className="bg-slate-50 rounded-xl p-4">
                  <h3 className="font-medium text-slate-700 mb-2">Refund Eligibility</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm font-medium text-green-700 mb-2">✓ Eligible for Refund</p>
                      <ul className="space-y-1 text-slate-600 text-sm">
                        <li>• First-time subscribers within 7 days</li>
                    ...
                    <div>
                      <p className="text-sm font-medium text-red-700 mb-2">✗ Not Eligible for Refund</p>
                      <ul className="space-y-1 text-slate-600 text-sm">
                        <li>• Requests after 7 days of purchase</li>
                        <li>• Renewal payments (monthly auto-renewals)</li>
                ...
                <div className="bg-slate-50 rounded-xl p-4">
                  <h3 className="font-medium text-slate-700 mb-2">How to Request a Refund</h3>
                  <ol className="space-y-2 text-slate-600 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#5b9a8b] text-white text-xs flex items-center justify-center shrink-0">1</span>
                      Email us at <a href="mailto:support@glucovital.fit" className="text-[#5b9a8b] underline">support@glucovital.fit</a> with subject "Refund Request"
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#5b9a8b] text-white text-xs flex items-center justify-center shrink-0">2</span>
                      Include your registered email address and reason for refund
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#5b9a8b] text-white text-xs flex items-center justify-center shrink-0">3</span>
                      Our team will review and respond within 2-3 business days
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#5b9a8b] text-white text-xs flex items-center justify-center shrink-0">4</span>
                ...
                {/* Refund processing */}
                <div className="bg-slate-50 rounded-xl p-4">
                  <h3 className="font-medium text-slate-700 mb-2">Refund Processing</h3>
                  <ul className="space-y-2 text-slate-600 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#5b9a8b] mt-2"></span>
              ...
              <div className="bg-amber-50 rounded-xl p-4 border border-amber-200 flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-700 text-sm">
                    GlucoVital.fit is a health tracking tool and does not provide medical advice. Refunds will not be granted based on medical outcomes or health-related expectations. Always consult a qualified healthcare provider for medical decisions.
                  </p>
                </div>
              </div>
            </section>
