...
import { Home, History, User, Menu, X, MessageCircle, LogOut, Trophy, FileText, Activity, Stethoscope, Share2, Heart, Shield } from "lucide-react";
...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
    ...
    ...(isAdmin ? [{ name: "Admin", icon: Shield, page: "AdminDashboard" }] : [])
  ];
